...
<div class="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 group">
  ...
  <!-- TOOLTIP -->
  <div class="bg-white/95 backdrop-blur-md px-4 py-2 rounded-2xl shadow-xl border border-black/5 
              translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 
              transition-all duration-300 pointer-events-none mb-1">
    <p class="text-primary font-medium text-sm whitespace-nowrap">
  ...
  >
    <!-- ANIMACIÓN PULSANTE (Efectos de ondas) -->
    <div class="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-20"></div>
    <div class="absolute inset-0 rounded-full bg-[#25D366] animate-pulse opacity-40"></div>
